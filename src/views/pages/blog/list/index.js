    ...
    return data.map(item => {
      ...
      return (
        <Col key={item.title} md='6'>
          <Card>
            <Link to={`/pages/subjects/detail/${item.id}`}>
              <CardImg className='img-fluid' src={item.img} alt={item.title} top />
            </Link>
            <CardBody>
              <CardTitle tag='h4'>
                <Link className='blog-title-truncate text-body-heading' to={`/pages/subjects/detail/${item.id}`}>
                  {item.title}
                </Link>
              </CardTitle>
              <Media>
              ...
              <div className='d-flex justify-content-between align-items-center'>
                ...
                <Link className='font-weight-bold' to={`/pages/subjects/detail/${item.id}`}>
                  Read More
                </Link>
              </div>
            </CardBody>
