  ...
  return (
    <div className='auth-wrapper auth-v2'>
      <Row className='auth-inner m-0'>
        ...
        <img src={LOGO} style={{width : '70px', height : "70px", borderRadius : '10px'}} className= "shadow" />
          ...
          {/* <h2 className='brand-text text-primary ml-1'>TextBook</h2> */}
        </Link>
            ...
            <Form action='/' className='auth-register-form mt-2' onSubmit={handleSubmit(onSubmit)}>
              ...
              <FormGroup>
                ...
                <InputPasswordToggle
                  ...
                  innerRef={register({ required: true, validate: value => value !== '' })}
                />
                <div className='mb-1 d-flex float-right mt-1'>
