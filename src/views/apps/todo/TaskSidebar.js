...
const TaskSidebar = props => {
  ...
  const [title, setTitle] = useState(''),
    [assignee, setAssignee] = useState({ value: '', label: '', img: img1 }),
  ...
  const assigneeOptions = [
    { value: 'nuwan', label: 'Nuwan Perera', img: img1 },
    { value: 'ashen', label: 'Ashen Rathnayaka', img: img2 },
    { value: 'suneth', label: 'Suneth Kasun', img: img3 },
    { value: 'tharindu', label: 'Tharindu Werarathna', img: img4 },
    { value: 'mohommad', label: 'Mohommad Hurran', img: img5 },
    { value: 'jevan', label: 'Jevan Mendis', img: img6 }
  ]
