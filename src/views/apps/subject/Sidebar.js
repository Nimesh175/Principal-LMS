...
const SubjectSidebar = props => {
  // ** Props
  const { handleSubjectsSidebar, setMainSidebar, mainSidebar, dispatch, getSubjectsSubjects, params } = props

  // ** Functions To Handle List Item Filter
  const handleFilter = filter => {
    dispatch(getSubjects({ ...params, filter }))
  }

  const handleTag = tag => {
    dispatch(getSubjects({ ...params, tag }))
  }
        ...
        <div className='sidebar-content todo-sidebar'>
          <div className='todo-app-menu'>
            <div className='add-task'>
              <Button.Ripple color='success' onClick={handleAddClick} block>
                Add Subjects
              </Button.Ripple>
            </div>
