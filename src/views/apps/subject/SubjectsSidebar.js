...
const SubjectsSidebar = props => {
  ...
  const assigneeOptions = [
    { value: 'nimal', label: 'Nimal Perera', img: img1 },
    { value: 'asitha', label: 'Ashen Rathnayaka', img: img2 },
    { value: 'tharidu', label: 'Tharindu Werarathna', img: img3 },
    { value: 'mohommad', label: 'Mohommad Hurran', img: img4 },
    { value: 'jevan', label: 'Jevan Mendis', img: img5 },
    { value: 'buddika', label: 'Buddika Dahanayaka', img: img6 }
  ]
