...
// GET: Return Tasks
// ------------------------------------------------
mock.onGet('/apps/classes/tasks').reply(config => {
...
// POST: Add new task
// ------------------------------------------------
mock.onPost('/apps/classes/add-tasks').reply(config => {
...
// POST: Update Task
// ------------------------------------------------
mock.onPost('/apps/classes/update-task').reply(config => {
...
// DELETE: Remove Task
// ------------------------------------------------
mock.onDelete('/apps/classes/delete-task').reply(config => {
