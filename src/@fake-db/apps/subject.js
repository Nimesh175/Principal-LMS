...
// GET: Return Tasks
// ------------------------------------------------
mock.onGet('/apps/subject/tasks').reply(config => {
...
// POST: Add new task
// ------------------------------------------------
mock.onPost('/apps/subject/add-tasks').reply(config => {
...
// POST: Update Task
// ------------------------------------------------
mock.onPost('/apps/subject/update-task').reply(config => {
...
// DELETE: Remove Task
// ------------------------------------------------
mock.onDelete('/apps/subject/delete-task').reply(config => {
